...
const Navbar1 = () => {
  return (
    <div className="navbar1 flex items-center justify-between py-7 px-9 text-base text-[#555555] sticky top-0 z-50 bg-white">
      <div className="logo cursor-pointer">
        <Link href="/">
          <Image src="/logo.webp" alt="desc" width={164} height={60} className=" bg-white"/>
        </Link>
      </div>
      <div className="navigate flex gap-7 items-center justify-between bg-white">
        ...
        >
          Home<span className="dropdown pl-2 font-thin text-[#a3a3a3] bg-white">+</span>
        </Link>
        <Link
          href="/about"
          className="links font-semibold text-[1.1rem] hover:text-[#0c59db] bg-white"
        ...
        >
          Services
          <span className="dropdown pl-2 font-thin text-[#a3a3a3] bg-white">+</span>
        </Link>
        <Link
          href="/pages"
          className="links font-semibold text-[1.1rem] hover:text-[#0c59db] bg-white"
        >
          Pages<span className="dropdown pl-2 font-thin text-[#a3a3a3] bg-white">+</span>
        </Link>
        <Link
          href="/blog"
          className="links font-semibold text-[1.1rem] hover:text-[#0c59db] bg-white"
        >
          Blog<span className="dropdown pl-2 font-thin text-[#a3a3a3] bg-white">+</span>
        </Link>
        <Link
          href="/contact"
          className="links font-semibold text-[1.1rem] hover:text-[#0c59db] bg-white"
