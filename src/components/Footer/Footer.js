...
const Footer = () => {
  return (
    <div className="footer text-white bg-[#00152e] w-full">
      <div className="upperpart bg-[#00152e] flex justify-start gap-[7em] mx-auto py-[6em] w-[80%] border-b-[0.3px] border-[#616161]">
        <div className="bg-[#00152e] w-[32%]">
          <Image
            src="/footer.webp"
            alt="desc"
            width={164}
          ...
          <p className="bg-[#00152e] text-[#c2d1e2] tracking-wide leading-7 w-[90%]">
          ...
          <div className="bg-[#00152e] text-[#c2d1e2] flex flex-row gap-12 ">
            <div className="bg-[#00152e]">
              <ul className="list-none">
                <li className="bg-[#00152e] text-sm tracking-wider cursor-pointer">
                  <i className="fa-solid fa-chevron-right bg-[#00152e] text-xs pr-2 pb-8"></i>
                  Home
                </li>
                <li className="bg-[#00152e] text-sm tracking-wider cursor-pointer">
                  <i className="fa-solid fa-chevron-right bg-[#00152e] text-xs pr-2 pb-8"></i>
        ...
        <div className="bg-[#00152e] w-[32%]">
          ...
          <i className="fa-solid fa-chevron-right bg-[#00152e] text-[10px] pr-2 pb-8 pt-5 text-[#0c59db]"></i>
